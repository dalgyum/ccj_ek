...
const WEDDING_CONFIG = {
  ...
  venue: {
    ...
    parking: '교회 내 주차 공간이 협소하오니 가급적 대중교통 이용을 부탁드립니다.'
  },
  ...
  accounts: {
    groom: [
      ...
      { label: '아버지', holder: '문만표', bank: '우리은행', number: '109-07-160575' },
      { label: '어머니', holder: '김인희', bank: '하나은행', number: '157-002643-00107' }
    ],
    bride: [
      { label: '신부', holder: '김민정', bank: '국민은행', number: '91051378218', payLink: '' },
      { label: '아버지', holder: '김광기', bank: '농협', number: '302-1157-6170-41' },
      { label: '어머니', holder: '김종순', bank: '농협', number: '972-02-229362' }
    ]
  },
